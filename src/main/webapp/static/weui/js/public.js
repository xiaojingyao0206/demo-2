...
var checkAllCommon = function(obj,name) {
	 ...
	 * @param userId
	 */
	function userCheckAndSub(callback){
		var config = {
				text:'',
				username:'',
				password:'',
				...
				onRegister:function() {
					window.location.href="./reg-home.do#main";
				}
		};
...
//接口未调暂时隐藏            +'<div class="weui-cell weui-cell_select" style="padding-left:11px;margin-top:5px"><div class="weui-cell__bd"><select class="weui-select" name="userType" id="userType">'+
...
/*	      {
	      ...
	      {
	    	    text: defaults.buttonRegister,
		        className: "default",
		        onClick: function () {
		          $.closeModal();
		          config.onRegister && config.onRegister.call(modal);
		       }
	      },
	      {
	    	  text: defaults.buttonOK,
		        ...
		        onClick: function() {
		          ...
		          var flag = config.onOK && config.onOK.call(modal, input);
		          if(flag !== false){
		        	  $.closeModal();
		          }
		        }
