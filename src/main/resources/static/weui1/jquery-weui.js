...
+ function($) {
  ...
  $.promptt = function(title,callbackOK, callbackCancel) {
	    if (typeof title === 'function') {
	      callbackCancel = arguments[2];
	      callbackOK = arguments[1];
	      title = undefined;
	    ...
	    return $.modal({
	      text: "<p class='weui-prompt-text'>"+("")+"</p><input type='text' class='weui_input weui-prompt-input' placeholder='身份证'  id='userName' />"+
	      "<p class='weui-prompt-text'>"+("")+"</p><input type='password' class='weui_input weui-prompt-input' placeholder='密码'  id='passWord' size='16'/>",
	      title: title,
	      buttons: [
{
    text: defaults.buttonLogin,
    className: "primary",
    onClick: function() {
      callbackOK && callbackOK($("#userName").val(),$("#passWord").val());
    }
  }     
	      ,
	      {
	        text: defaults.buttonregist,
	        className: "primary",
	        onClick: function() {
	        	location.href="wechatBuss_register.do";
	        }
	      }
	      ,
	      {
	  ...
	  $.prompttt = function(title,callbackOK, callbackCancel) {
		    if (typeof title === 'function') {
		      callbackCancel = arguments[2];
		      callbackOK = arguments[1];
		      title = undefined;
		      ...
		      buttons: [
	{
	    ...
	    onClick: function() {
	      callbackOK && callbackOK($("#userName").val(),$("#passWord").val());
		      ...
		      ,
		      {
		        ...
		        className: "primary",
		        onClick: function() {
		        	location.href="wechatBuss_register.do?sjtype=org";
		        }
		      }
		      ,
		      {
	  ...
	  $.promptres = function(title,callbackOK, callbackCancel) {
		    if (typeof title === 'function') {
		      callbackCancel = arguments[2];
		      callbackOK = arguments[1];
		      title = undefined;
		    ...
		    return $.modal({
		      text: "<p class='weui-prompt-text'>"+("")+"</p><input type='text' class='weui_input weui-prompt-input' placeholder='用户名'  id='userName' />"+
		      "<p class='weui-prompt-text'>"+("")+"</p><input type='password' class='weui_input weui-prompt-input' placeholder='密码'  id='passWord' size='16'/>"+
		      "<p class='weui-prompt-text'>"+("")+"</p><input type='password' class='weui_input weui-prompt-input' placeholder='重复密码' size='16' id='repassWord'/>"+
		      "<p class='weui-prompt-text'>"+("")+"</p><input type='text' class='weui_input weui-prompt-input' placeholder='身份证号码'  id='idCard'/>",
		      title: title,
		      buttons: [
		      {
		        text: defaults.buttonCancel,
		      ...
		      },
		      {
		        ...
		        className: "primary",
		        onClick: function() {
		          callbackOK && callbackOK($("#userName").val(),$("#passWord").val(),$("#repassWord").val(),$("#idCard").val());
		        }
		      }]
		    });
		  };
